...
?>
<div class="tripreceipt-point-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Tripreceipt Point', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Request', 'id' => 'grid--cuser_id']
            ],
        [
                'attribute' => 'id_trip',
                'label' => 'Id Trip',
                'value' => function($model){
                    return $model->id_trip;
                },
                'filterType' => GridView::FILTER_SELECT2,
